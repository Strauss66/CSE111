...
"""
The following functions are testing everything we got from the water_flow file
if you want to understan it more and learn what it actually does go to that file.
We are using the approx to and the decimals like 0.001 to get and approximation of 
